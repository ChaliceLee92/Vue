<template>
    <div class="teachContentManage">
        ...
        >
            ...
            <!-- 自定义渲染标签 -->
            <template v-slot:col-range="scope">
                <!-- 标签 -->
                ...
                <el-tag
                    v-for="(item, index) in scope.row.range"
                    :key="index"
        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    <!-- 自定义插槽的使用 -->
                    <template v-slot:form-range>
                        <el-checkbox-group v-model="formInfo.data.range">
                            <el-checkbox
                                v-for="item in listTypeInfo.typeList"
                                :key="item.value"
                                :label="item.value"
                            >
                                {{ item.key }}
...
<script>
import {
    getTeachResourceList,
    createTeachResourceList,
    updateTeachResourceList,
    DeleteTeachResourceList
    ...
    data() {
        ...
        return {
            ...
            tableInfo: {
                ...
                data: [],
                fieldList: [
                    { label: '教材排序', value: 'order', type: 'slot' },
                    { label: '图片', value: 'pic', type: 'image' },
                    { label: '教材名称', value: 'name' },
                    { label: '适用范围', value: 'range', type: 'slot' },
            ...
            listTypeInfo: {
                ...
                typeList: [
                    { key: '全部', value: '1' },
                    { key: '深圳附小学校等45所', value: '2' },
                    { key: '广州附小学校等45所', value: '3' }
                ]
            },
            // 弹框配置相关
            dialogInfo: {
        ...
        handleClick(event, data) {
            ...
            switch (event) {
                ...
                case 'update':
                    dialogInfo.type = event
                    dialogInfo.visible = true
                    this.ItemTeachResourceList = data
                    // 显示信息
