...
import { getTreeArr } from '@utils/mUtils'
...
export default {
    ...
    watch: {
        ...
        'treeInfo.baseData'(val) {
            // 得到树状数据
            this.treeInfo.treeData = getTreeArr({
                key: 'id',
                pKey: 'pid',
                data: val
            })
    ...
    methods: {
        ...
        initTree(val) {
            ...
            if (!treeInfo.initTree) {
                if (
                    treeInfo.defaultClickedAsyc ||
                    treeInfo.defaultClickedAsyc === 0
                ) {
                    treeInfo.defaultClicked = {
                        id: treeInfo.defaultClickedAsyc
                    }
                }
                if (
                    treeInfo.defaultHighLightAsyc ||
                    treeInfo.defaultHighLightAsyc === 0
                ) {
