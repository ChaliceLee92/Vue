<template>
	<el-dropdown trigger="click" class="international" @command="handleSetLanguage">
		<div>
			<svg class="svg-icon international-icon" aria-hidden="true" v-on="$listeners">
				<use xlink:href="#icon-language">
					<svg id="icon-language" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="100%" height="100%">
						<path
...
export default {
	...
	methods: {
		handleSetLanguage(lang) {
			...
			this.$message({
				message: this.$t('checkOutLanguage'),
				type: 'success'
			});
		}
	}
